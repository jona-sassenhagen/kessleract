...
export const LEVELS = [
  ...
  {
    id: "diagonal-strait",
    name: "Level 15: Diagonal Strait",
    objective: "Two diagonal gravity lanes cross through a narrow center. Spend one rocket to open the stream, and one to finish the survivors.",
    rocketBudget: 2,
    previewHorizon: 28,
    wells: [
      {
    ...
    satellites: [
      satelliteSpec({ wellId: "ember", orbitFamily: "inner", debrisYield: 5, rx: 148, ry: 142, phase: -1.18, rotation: deg(46), angularSpeed: 0.198, direction: 1 }),
      satelliteSpec({ wellId: "ember", orbitFamily: "transfer", debrisYield: 3, rx: 208, ry: 156, phase: -0.34, rotation: deg(46), angularSpeed: 0.148, direction: -1 }),
      satelliteSpec({ motionMode: "ballistic", orbitFamily: "relay", debrisYield: 2, x: CONFIG.width * 0.47, y: CONFIG.height * 0.57, vx: 28, vy: -28 }),
      satelliteSpec({ motionMode: "ballistic", orbitFamily: "sweep", debrisYield: 1, x: CONFIG.width * 0.56, y: CONFIG.height * 0.45, vx: -24, vy: 20 }),
      satelliteSpec({ wellId: "tide", orbitFamily: "outer", debrisYield: 5, rx: 238, ry: 146, phase: 2.46, rotation: deg(46), angularSpeed: 0.11, direction: 1 }),
      satelliteSpec({ wellId: "tide", orbitFamily: "sweep", debrisYield: 1, rx: 180, ry: 138, phase: 1.28, rotation: deg(46), angularSpeed: 0.156, direction: -1 }),
      satelliteSpec({ wellId: "tide", orbitFamily: "polar", debrisYield: 0, rx: 286, ry: 112, phase: -2.2, rotation: deg(46), angularSpeed: 0.09, direction: 1 }),
    ],
  },
  {
